...
- (void)squareBox:(CGRect)rect {
    ...
    [path addLineToPoint:CGPointMake(width - coner, 0)];
    [path addQuadCurveToPoint:CGPointMake(width, coner) controlPoint:CGPointMake(width, 0)];
    [path addLineToPoint:CGPointMake(width, height - coner)];
    [path addQuadCurveToPoint:CGPointMake(width - coner, height) controlPoint:CGPointMake(width, height)];
